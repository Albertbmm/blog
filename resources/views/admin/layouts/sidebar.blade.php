<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      <li class="header">Create NAVIGATION</li>
      <li class="active treeview">
          <li class=""><a href="{{route('post.create')}}"><i class="fa fa-circle-o"></i> Post</a></li>
          <li class=""><a href="{{route('tag.create')}}"><i class="fa fa-circle-o"></i> Categories & Tags</a></li>
          <li class=""><a href="{{route('user.create')}}"><i class="fa fa-circle-o"></i> Users</a></li>
      </li>
